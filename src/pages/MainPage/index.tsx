  ...
  return (
    <Container fullWidth={openTax}>
      {!openTax ? <>
          ...
          <br/>
          <br/>
          <Typography variant="body1" align="justify"> <b>Taging process:</b> In th following link, you will find the information related to the lagels assigned per each tagger. </Typography>
        </>
